...
import com.yoyoG.makeiteven2.data_models.Level
import com.yoyoG.makeiteven2.extras.Constants
import com.yoyoG.makeiteven2.intefaces.IFragmentLevelsScreenListener
...
class FragmentLevelsScreen : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        context?.let {
            AudioManager.getInstance(it).playLoopMusicForSpecificFragment(Constants.LEVELS_SCREEN_FRAGMENT_TAG)
